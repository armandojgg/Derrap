...
public class consultarPedidosMecanico extends JFrame {
	...
	private JLabel lblSegundoIcono, lblMisPedidos;
	 ...
	 * Create the frame.
	 */
	public consultarPedidosMecanico() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setTitle("Consultar pedidos - MECÁNICO"); // Título de la ventana en cuestión
