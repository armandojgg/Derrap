...
public class vehiculosMecanico extends JFrame {
	...
	private JLabel lblMecanico, lblIconoCasa, lblIcono, lblLogOut, lblImagenLogOut, lblPoweredDerrap, lblVehiculos;
	 ...
	 * Create the frame.
	 */
	public vehiculosMecanico() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setTitle("Vehículos - MECÁNICO"); // Título de la ventana en cuestión
